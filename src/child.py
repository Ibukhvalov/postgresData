...
class Child:
    ...
    def perform_search(self):
        if (self.search_type.get() == "topic"):
            print("функция для поиска писем по топику и birth_certificate", self.birth_certificate, self.search_type.get())
        else:
            print("функция для поиска поиска писем по году и birth_certificate", self.birth_certificate, self.search_type.get())
    ...
    def get_child_info(self, birth_certificate, child_info):
        print("функция для получения информации о ребенке по birth_certificate = ", birth_certificate)
    ...
    def delete_profile(self):
        print("функция удаления всей информации о ребенке по self.birth_certificate = ", self.birth_certificate)
    ...
    def delete_email(self, year, email_window):
        print("ункция для удаления конкретного письма ребенка по self.birth_certificate и по year")
    ...
    def save_email(self, year, topic, description, email_window):
        ...
        print("функция для апдейта письма по birth_certificate, year и даны новые данные топика и дескриптион")
        #self.app.dbcontroller.edit(year, topic, description)
    ...
    def show_emails(self):
        ...
        print("функция для поиска всех писем ребнка по birth_certificate")
    ...
    def send_email(self, topic, description):
        ...
        print("функция для отправки письма ребенка по self.birth_certificate", topic, description)
