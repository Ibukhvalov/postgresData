...
class Authorization:
    ...
    def open_registration(self):
        ...
        self.reg_full_name_entry = tk.Entry(registration_frame, show='*')
        ...
        self.reg_date_of_birth_entry = tk.Entry(registration_frame, show='*')
        ...
        self.reg_postcode_entry = tk.Entry(registration_frame, show='*')
    ...
    def register(self):
        ...
        date_of_birth = self.reg_date_of_birth_entry.get()
        ...
        print("функция для регистрации ребенка (записи всех его данных в бд)")
    ...
    def login(self):
        ...
        print("функция для проверки логина и пароля child_login")
    ...
    def login_for_santas(self):
        ...
        print("функция для проверки никнейма и пароля санты santa_login")
